...
Okay so the main resource is the practise exam. Now I need a component that graphs equations, ill give you the executive freedom on how you want to structure it. Correctness is the highest priority, maybe or maybe not an external solution exists. idk.